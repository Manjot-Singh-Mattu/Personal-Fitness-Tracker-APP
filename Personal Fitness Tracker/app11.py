...
def install_requirements():
    try:
        import streamlit  # Try importing a package from requirements
    except ImportError:
...
st.markdown(
   ...
   .lottie-container {{ 
        ...
        width: 100%; 
        height: auto; 
        background-color: {streamlit_background_color};
        padding: 20px; 
        border-radius: 5px; 
        margin-bottom: 20px; 
    }}
...
# ---- HEADER SECTION ----
st.markdown("<h1 class='main-header'>🏋️ Personal Fitness Tracker 🏋️</h1>", unsafe_allow_html=True)
    ...
    if X_train is not None:
        ...
        if model:
            ...
            try:
                ...
                st_lottie(animation_data, speed=1, width=1050, height=300)
